        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1 bg-neutral-900 border border-neutral-800/80 p-1 rounded-xl">
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-black transition-colors cursor-pointer ${
            ...
            >
              ...
              <span className="text-[9px] sm:text-xs">AUTO FRAMES</span>
